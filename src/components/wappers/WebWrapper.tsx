...
const WebWrapper: FunctionComponent<{ children: JSX.Element }> = ({ children }) => {
  ...
  return (
    <Center>
      <Alert marginTop="30%" w="90%" maxW="400" status="error" colorScheme="error">
        <VStack space={2} flexShrink={1} w="100%">
          ...
          <Box pl="6">
            {t('errors.web_window_size.description')}
          </Box>
        </VStack>
      </Alert>
    </Center>
